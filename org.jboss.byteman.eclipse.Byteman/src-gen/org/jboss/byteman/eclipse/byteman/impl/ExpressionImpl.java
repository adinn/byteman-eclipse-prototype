...
public class ExpressionImpl extends ConditionImpl implements Expression
{
  ...
  {
    return BytemanPackage.Literals.EXPRESSION;
  }
  ...
  public void setOp(String newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BytemanPackage.EXPRESSION__OP, oldOp, op));
  }
  ...
  public NotificationChain basicSetOperand1(Expression newOperand1, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BytemanPackage.EXPRESSION__OPERAND1, oldOperand1, newOperand1);
  ...
  public void setOperand1(Expression newOperand1)
  {
    if (newOperand1 != operand1)
    {
      ...
      if (operand1 != null)
        msgs = ((InternalEObject)operand1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BytemanPackage.EXPRESSION__OPERAND1, null, msgs);
      if (newOperand1 != null)
        msgs = ((InternalEObject)newOperand1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BytemanPackage.EXPRESSION__OPERAND1, null, msgs);
      msgs = basicSetOperand1(newOperand1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BytemanPackage.EXPRESSION__OPERAND1, newOperand1, newOperand1));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BytemanPackage.EXPRESSION__OP:
        return getOp();
      case BytemanPackage.EXPRESSION__OPERAND1:
        return getOperand1();
    }
