 ...
 * <ul>
 *   <li>{@link org.jboss.byteman.eclipse.byteman.impl.ActionListImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionListImpl extends MinimalEObjectImpl.Container implements ActionList
{
  ...
  {
    return BytemanPackage.Literals.ACTION_LIST;
  }
  ...
  public EList<Action> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Action>(Action.class, this, BytemanPackage.ACTION_LIST__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BytemanPackage.ACTION_LIST__ACTIONS:
