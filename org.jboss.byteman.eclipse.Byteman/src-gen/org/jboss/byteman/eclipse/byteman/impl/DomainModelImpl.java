 ...
 * <ul>
 *   <li>{@link org.jboss.byteman.eclipse.byteman.impl.DomainModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainModelImpl extends MinimalEObjectImpl.Container implements DomainModel
{
  ...
  {
    return BytemanPackage.Literals.DOMAIN_MODEL;
  }
  ...
  public EList<Element> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Element>(Element.class, this, BytemanPackage.DOMAIN_MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BytemanPackage.DOMAIN_MODEL__ELEMENTS:
